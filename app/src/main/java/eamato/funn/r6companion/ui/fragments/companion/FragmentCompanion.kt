...
@AndroidEntryPoint
class FragmentCompanion : ABaseFragment<FragmentCompanionBinding>() {

    override val bindingInitializer: (LayoutInflater) -> ViewBinding = FragmentCompanionBinding::inflate
