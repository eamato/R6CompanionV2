...
const val NOTIFICATION_DATA_TITLE_KEY = "title"
const val NOTIFICATION_DATA_BODY_KEY = "body"

const val SCREEN_NAME_ABOUT_APP = "About screen"
const val SCREEN_NAME_HOME = "Home screen"
const val SCREEN_NAME_COMPANION_MAPS = "Maps screen"
const val SCREEN_NAME_MAP_DETAILS = "Map details"
const val SCREEN_NAME_NEWS_DETAILS = "News details screen"
const val SCREEN_NAME_OPERATOR_DETAILS = "Operator details screen"
const val SCREEN_NAME_COMPANION_OPERATORS = "Operators screen"
const val SCREEN_NAME_ROULETTE = "Roulette screen"
const val SCREEN_NAME_ROULETTE_RESULT = "Roulette result screen"
const val SCREEN_NAME_SETTINGS = "Settings screen"
const val SCREEN_NAME_COMPANION_WEAPONS = "Weapons screen"
const val SCREEN_NAME_IMAGE_VIEW = "Image view screen"